    ...
    //console.log("C- Output XML - Line 958", fatcaresult2[0].return_msg._text)
      ...
      if(fatcaresult==0){    
        agmess= {
           status:200,
           message:'Successfull',            
           data:  { "Unique_No ": ashdata1,"Trxn_No: ": ashdata2 ,"Application_No: ": ashdata3, "Fund: ": ashdata4,"Scheme: ": ashdata5, "Scheme_Name: ": ashdata6, "Amt: ": ashdata7,"Status_Desc ":ashdata8,"Status_code ":ashdata9,"Input_ref_no ":ashdata10,"Paymentlink ":fatcaresult2.Paymentlink._text.substring(9,(fatcaresult2.Paymentlink._text.length+3)*.5),},  
           message_full: fatcaresult2 ,
         }
       }else{
         agmess= {
   ...
   //return
    //Customer.perchase_normal((err, data) => {
      ...
      let ash_arrk={NMFIIService:{
        ...
        sip_ac_type: postarray.sip_ac_type,
        sip_ifsc_code: urs.ifsc_code,
        ...
        reinvest: postarray.reinvest,
        amount: postarray.amount,
        sip_from_date: '10-Dec-2020',
        sip_end_date: '31-Dec-2099',
        sip_freq: 'OM',
        sip_amount: '2000',
        sip_period_day: '10',
        input_ref_no: postarray.input_ref_no,
